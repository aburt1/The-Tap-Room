    ...
    <div class="wrapper fadeInDown">
        ...
        <div id="formContent">
            <div class="fadeIn first">
                <br>
                <i><div class="my-logo">TheTapRoom</div></i>
                <hr>
            </div>
            <form method="post" action="">
                <div id="div_login">
                    <input type="text" id="txt_uname" class="fadeIn second" name="txt_uname" placeholder="Swipe card to begin (Enter an integer 1-100)">
